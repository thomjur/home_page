...
<h3><a href="{{ site.baseurl }}{% link projects/religionml.md %}"> ReligionML Corpus Annotation for Machine Learning</a></h3>
...
<h3><a href="{{ site.baseurl }}{% link projects/religioid.md %}"> A Quantitative Analysis of the Dissemination of Religious Notions in Contemporary English Texts</a></h3>
<p class="project-teaser">
...
<h3><a href="https://ceres.rub.de/en/research/projects/arelinco/" target="_blank"> ARELINCO: Ancient Religion(s) in Contact: Contemporary Religious Phenomena and Their Ancient Predecessors</a></h3>
<p class="project-teaser">
